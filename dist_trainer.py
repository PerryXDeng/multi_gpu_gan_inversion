...
class Trainer(nn.Module):
    def __init__(self, config, opts):
        ...
        self.dlatent_avg = Parameter(stylegan_state_dict['latent_avg'], requires_grad=False)
    ...
    def get_image(self, w=None, img=None, noise=None):
    ...
    def compute_loss_stylegan2(self, w=None, img=None, noise=None, real_img=None):
        ...
        if self.opts.save_train_reconstruction:
            ######### FOR DEBUGGING
